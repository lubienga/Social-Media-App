...
if(isset($_POST['login']) && $_SERVER['REQUEST_METHOD'] == "POST") {
	// sleep(1);
	$data['email'] = htmlentities(stripslashes(strip_tags(mysql_real_escape_string(trim($_POST['email'])))));
	$data['password'] = htmlentities(stripslashes(strip_tags(mysql_real_escape_string(trim($_POST['password'])))));
	$data['remember'] = htmlentities(stripslashes(strip_tags(mysql_real_escape_string(trim($_POST['remember'])))));
	//get saved data to compare with login credentials
	if($results=$user->login($data['email'], $data['password'])) {
		if($results == "success") {
...
if(isset($_POST['signup']) && $_SERVER['REQUEST_METHOD'] == "POST") {
	sleep(1);
	$data['firstname'] = stripcslashes(strip_tags(mysql_real_escape_string(trim($_POST['firstname']))));
	$data['lastname'] = stripcslashes(strip_tags(mysql_real_escape_string(trim($_POST['lastname']))));
	$data['email'] = stripcslashes(strip_tags(mysql_real_escape_string(trim($_POST['email']))));
	$data['password'] = stripcslashes(strip_tags(mysql_real_escape_string(trim($_POST['password']))));
